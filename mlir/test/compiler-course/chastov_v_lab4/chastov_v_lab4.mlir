// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/CeilPlugin_Chastov_Vyacheslav_FIIT2_MLIR%shlibext \
// RUN: --pass-pipeline="builtin.module(CeilPlugin_Chastov_Vyacheslav_FIIT2_MLIR)" %s | FileCheck %s
